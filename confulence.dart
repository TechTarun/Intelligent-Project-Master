...
class Confulence extends StatefulWidget {
  @override
  _ConfulenceState createState() => _ConfulenceState();
}

class _ConfulenceState extends State<Confulence> {
    ...
    return Scaffold(
        ...
        body: Container(
          decoration: BoxDecoration(
            ...
            colors: [Color(0xff6600ff), Color(0xff000000)],
          )),
          child: Column(
            children: <Widget>[
              Container(
                  padding: EdgeInsets.fromLTRB(50.0, 30.0, 50.0, 0.0),
                  child: Image.asset('assets/confluence.jpg',
                      height: 200,
                      width: 300,
